...
def split(dataset):
    training_set, test_set = tts(dataset, test_size=0.2)
    training_set, validation_set = tts(dataset, test_size=0.25) # 0.8*0.25 = 0.2
...
tr_set, val_set, test_set = split(new_dataset)